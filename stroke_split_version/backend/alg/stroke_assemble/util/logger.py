...
class Logger:
	...
	def __init__(self, model_name, data_name,runs='runs'):
		...
		train_log_dir = os.path.join(self.runs_dir ,current_time + self.comment + r'/train')
		test_log_dir = os.path.join(self.runs_dir ,current_time + self.comment + r'/test')
	...
	def _save_torch_images(self, grid, epoch, n_batch, comment=''):
		out_dir = self.runs_dir+'/images/{}'.format(self.data_subdir)
	...
	def save_model(self, model, file_name):
		out_dir = self.runs_dir+'/models/{}'.format(self.data_subdir)
	...
	def load_model(self, model, file_name):
		dir = self.runs_dir+'/models/{}'.format(self.data_subdir)
